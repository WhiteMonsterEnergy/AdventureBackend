...
//        when(profileRepository.findByNameAndPassword("Alice", "secret")).thenReturn(Optional.of(profile));
//
//        // Act
...
//        // Arrange
//        when(profileRepository.findByNameAndPassword("Bob", "wrong")).thenReturn(Optional.empty());
//
//        // Act
...
//        // Arrange
//        Profile profile = new Profile(2, "Eve", "pass", ProfileType.EMPLOYEE);
...
//        Profile p2 = new Profile(2, "B", "p2", ProfileType.EMPLOYEE);
...
//        // Arrange
//        Profile profile = new Profile(3, "C", "old", ProfileType.EMPLOYEE);
//
//        // Act
